...
@section('title')اكثر المواضيع مشاهدة@endsection
...
<div class="articals">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h2 style="font-weight: bold">اكتر المواضيع مشاهدة</h2></div>
            <div class="panel-body">
                @foreach ($bigviews as $articals)
...
@else
<h2 style="font-weight: bold;color: red;text-align: center;padding: 206px;">لا يوجد نسب مشاهدة عالية حتى الان</h2>
@endif
@endsection
