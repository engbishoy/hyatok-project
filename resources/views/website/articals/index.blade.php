...
<div class="articals">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h2 style="font-weight: bold">{{$section->title}}</h2></div>
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <div class="important" style="overflow-wrap: break-word">
                    <h2>مقالات متنوعة</h2>
                    <hr>
                    @foreach ($allartical as $imp)
                    <a href="{{route('showarticalsection',['id'=>$imp->id,'title'=>$imp->title])}}" style="font-size: 19px;font-weight: bold">{{$imp->title}}</a>                        
                    <br>
                    <br>
                    @endforeach
                </div>
...
@else
<h2 style="font-weight: bold;color: red;text-align: center;padding: 206px;">لا يوجد اى مقالات بهذا القسم حتى الان</h2>
@endif
@endsection
