...
<div class="articals">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h2 style="font-weight: bold">نتائج البحث</h2></div>
            <div class="panel-body">
                @foreach ($allartical as $articals)
                    ...
                    <a href="{{route('showarticalsection',['id'=>$articals->id,'title'=>$articals->title])}}">
                        ...
                        <img class="img-responsive" style="width: 207px;margin:auto" src="{{asset("imges/img artical/$articals->photo")}}">
...
@else
<h2 style="font-weight: bold;color: red;text-align: center;padding: 206px;">لا يوجد نتائج لهذا البحث</h2>
@endif
@endsection
