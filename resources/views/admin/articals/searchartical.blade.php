...
<td><h4> {{Str::limit($articals->title,50)}}</h4></td>
...
<span class='btn btn-info' style='font-size:16px'><a style="color:white;text-decoration:none;" href=''><i class='fa fa-thumbs-up'></i>اوافق</a></span>
...
<button type='submit' class='btn btn-danger' style="font-size:16px"><i class="fa fa-trash"></i> حذف</button>
      ...
      @endforeach
        ...
        @else
        <h2 style="text-align: center;font-weight: bold;color: red">لا يوجد اى مقالات بهذا الاسم</h2>
      @endif
